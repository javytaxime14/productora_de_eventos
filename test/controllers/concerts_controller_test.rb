...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { attendance: @concert.attendance, date: @concert.date, duration: @concert.duration, group_id: @concert.group_id } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { attendance: @concert.attendance, date: @concert.date, duration: @concert.duration, group_id: @concert.group_id } }
